...
<div class="container">
	...
	<form id="orderForm" action="/order/add" method="post">
		<div class="orderDetail">
			...
			<h5>
				적립예정포인트: <input id="mpoint" name="mpoint" readonly="readonly">
			</h5>
			<hr>
		</div>
		<div class="orderDetail">
		...
		<div class="orderDetail">
			...
			<input type="text" name="memo" <textarea style="border: none" cols="" rows=""/>>
		</div>
		<input type="hidden" id="orderpname" name="pname" value=""> <input
			type="hidden" id="orderamount" name="amount" value=""> <input
			type="hidden" id="ordermno" name="mno" value="${sesInfo.mno }">
